...
| `state`                                                                 | `scored` when every scenario was reached, else `incomplete`. An `incomplete` run carries no usable score: **do not render its `index` or `rps` as a result.** See `submissions/RANKED.md`, "Void runs", for what happens to one.                                                                                                                                      |
